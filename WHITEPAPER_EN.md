...
- Anchor locally as file-based settlement snapshots with chain liveness verification (Alpha); on-chain tx-level anchoring in Beta; full consensus-level multi-validator settlement in Mainnet
